...
- (up) Add `--offline` flag by @szokeasaurusrex in [#325](https://github.com/getsentry/devservices/pull/325)
...
- Make `get_installed_remote_dependencies` mode-aware by @szokeasaurusrex in [#326](https://github.com/getsentry/devservices/pull/326)
- Handle SSH-style GitHub URLs in dependency fetching by @lcian in [#322](https://github.com/getsentry/devservices/pull/322)
- Authed zip downloads by @joshuarli in [#321](https://github.com/getsentry/devservices/pull/321)
- Ignore_cleanup_errors to mitigate strange flakes in sentry CI by @joshuarli in [#312](https://github.com/getsentry/devservices/pull/312)

### Internal Changes 🔧

#### Deps

- Bump pygments from 2.19.2 to 2.20.0 by @dependabot in [#318](https://github.com/getsentry/devservices/pull/318)
- Bump urllib3 from 2.6.3 to 2.7.0 by @dependabot in [#317](https://github.com/getsentry/devservices/pull/317)
...
- Upgrade past needing pkg_resources by @dependabot in [#324](https://github.com/getsentry/devservices/pull/324)
- Remove secrets: inherit from changelog-preview workflow by @oioki in [#323](https://github.com/getsentry/devservices/pull/323)
- Replace git clone with zip downloads, reuse retry machinery by @joshuarli in [#314](https://github.com/getsentry/devservices/pull/314)
